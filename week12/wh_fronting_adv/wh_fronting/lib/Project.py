...
def testIntent():
    ...
    # s2f
    print("[TEST] s2f")
    inputLIST = ['你買了衛生紙','每個人都會買衛生紙','馬小莉不喜歡王小明','馬小莉最喜歡王小明','馬小莉一定會買衛生紙']
    testLoki(inputLIST, ['s2f'])
    print("")

    # s2f_adv
    print("[TEST] s2f_adv")
    inputLIST = ['馬小莉最喜歡台北市','馬小莉最喜歡牛肉麵','馬小莉最喜歡王小明']
    testLoki(inputLIST, ['s2f_adv'])
    print("")

    # s2f_adv_who
    print("[TEST] s2f_adv_who")
    inputLIST = ['馬小莉不喜歡王小明','馬小莉最喜歡王小明']
    testLoki(inputLIST, ['s2f_adv_who'])
    print("")
